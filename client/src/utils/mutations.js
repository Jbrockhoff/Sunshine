...
mutation CreateChild($room: ID!, $name: String!, $birthday: String!, $primaryContact: String!) {
  createChild(room: $room, name: $name, birthday: $birthday, primaryContact: $primaryContact) {
    birthday
    name
    primaryContact
  }
...
mutation CreateDocumentation($childId: ID!, $domain: String!, $note: String!, $goals: String!) {
  createDocumentation(childId: $childId, domain: $domain, note: $note, goals: $goals) {
    _id
    createdAt
    domain
    goals
...
mutation UpdateDocumentation($id: ID!, $updatedData: UpdateDocumentationInput!) {
